...
while True:
    ...
    regime_barrage = resultats.get_res_all_pseudoperm_var_at_emhs('RegimeBarrage', [branche_barrage.id])[:, 0]
    q_pilote = resultats.get_res_all_pseudoperm_var_at_emhs('Q', [section_pilote])[:, 0]
