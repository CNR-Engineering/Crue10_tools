...
class ScenarioTestCase(unittest.TestCase):
    ...
    def test_etu_validation(self):
        with self.assertLogs(level='INFO') as cm:
            ...
            self.assertEqual('\n'.join(cm.output), """ERROR:crue10.utils:~> 2 erreur(s) dans M3-6_c10.drso.xml:
...
ERROR:crue10.utils:~> 1 erreur(s) dans M3-6_c10.optr.xml:
ERROR:crue10.utils:    #1: Error XML: file is probably not well-formed or corrupted
ERROR:crue10.utils:=> 4 erreur(s) dans les fichiers XML""")
