...
class ResultatsCalculTestCase(unittest.TestCase):
    ...
    def test_summary(self):
        self.assertEqual(self.resultats.summary(), "Résultats run #R2023-04-21-15h39m47s (2 calculs permanents et 1 calcul transitoire)")

    def test_details(self):
        self.assertEqual(self.resultats.details(), """Résultats run #R2023-04-21-15h39m47s (2 calculs permanents et 1 calcul transitoire) :
