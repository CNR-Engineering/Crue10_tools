...
class EndToEndTestCase(unittest.TestCase):
    ...
    def same_folders(self, folder_in, folder_out, version_grammaire, etu_changed=True):
    ...
    def _test_write_from_scratch(self, version_grammaire):
        ...
        self.same_folders(folder_in, folder_out, version_grammaire, etu_changed=True)
    ...
    def test_read_gprec_and_write_all_gprec(self):
        ...
        self.same_folders(folder_in, folder_out, VERSION_GRAMMAIRE_PRECEDENTE, etu_changed=False)
