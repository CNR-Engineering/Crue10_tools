...
class ProfilCasier:
    """
    ProfilCasier
    - nom_profil_casier: current profil casier identifier
...
class Casier:
    ...
    - noeud <crue10.emh.section.Noeud>: related node
    - profils_casier <[ProfilCaser]>: profils casier (usually length=1)
    - comment <str>: optional text explanation
    """
    def __init__(self, nom_casier, nom_noeud, distance=0, is_active=False):
        self.id = nom_casier
